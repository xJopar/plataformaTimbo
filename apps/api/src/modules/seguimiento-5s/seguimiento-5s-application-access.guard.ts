...
export const SEGUIMIENTO_5S_APPLICATION_KEY = 'seguimiento-5s';

@Injectable()
export class Seguimiento5sApplicationAccessGuard implements CanActivate {
  public constructor(
  ...
  public async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    if (authenticatedUser === undefined) {
      throw new Error('El guard de sesión debe ejecutarse antes del guard de Seguimiento 5S.');
    }
