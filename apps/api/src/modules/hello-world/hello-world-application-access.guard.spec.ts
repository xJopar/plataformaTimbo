...
describe('HelloWorldApplicationAccessGuard', () => {
  const applicationAuthorizationService = { hasApplicationAccess: jest.fn() };
  const guard = new HelloWorldApplicationAccessGuard(
  ...
  it('autoriza al usuario que tiene Hello World asignada y activa', async () => {
