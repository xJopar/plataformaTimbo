...
export class MetaCompanyController {
  ...
  @ApiOperation({
    ...
    summary: 'Lista metas comerciales por periodo y empresa.',
  })
  ...
  ): Promise<MetaCompanyAdvisorGoalListItemDto[]> {
    const goals = await this.metaCompanyService.listGoals(
      period,
      empresaId === undefined ? undefined : Number(empresaId),
    );
    return [
      ...goals.brandGoals.map((goal) => ({
        id: goal.id,
  ...
  @ApiOperation({
    ...
    summary: 'Lista catalogos comerciales activos.',
  })
  ...
  @ApiOperation({
    ...
    summary: 'Lista todos los catalogos comerciales.',
  })
  @ApiOkResponse({ type: MetaCompanyCatalogResponseDto })
  ...
  @ApiOperation({
    ...
    summary: 'Obtiene las acciones habilitadas para la sesion.',
  })
  ...
  @ApiBody({ type: CreateMetaCompanyBrandGoalDto })
  @ApiCreatedResponse({ type: MetaCompanyBrandGoalResponseDto })
  public async createBrandGoal(
    @Req() request: AuthenticatedRequest,
    @Body() body: Record<string, unknown>,
  ) {
    return mapBrandGoal(
      await this.metaCompanyService.createBrandGoal(
        {
          period: stringValue(body.period),
          businessId: numberValue(body.businessId),
          brandId: numberValue(body.brandId),
          value: stringValue(body.value),
          workingDays: body.workingDays === undefined ? undefined : numberValue(body.workingDays),
        },
  ...
  @Post('advisor-goals')
  @UseGuards(CsrfProtectionGuard, MetaCompanyGoalManagementGuard)
  @ApiBody({ type: CreateMetaCompanyAdvisorGoalDto })
  @ApiCreatedResponse({ type: MetaCompanyAdvisorGoalResponseDto })
  public async createAdvisorGoal(
    @Req() request: AuthenticatedRequest,
    @Body() body: Record<string, unknown>,
  ) {
    return mapAdvisorGoal(
      await this.metaCompanyService.createAdvisorGoal(
        {
          period: stringValue(body.period),
          businessId: numberValue(body.businessId),
          brandId: body.brandId === undefined ? undefined : numberValue(body.brandId),
          advisorId: numberValue(body.advisorId),
          value: stringValue(body.value),
          workingDays: body.workingDays === undefined ? undefined : numberValue(body.workingDays),
        },
        requireAuthenticatedUserId(request),
  ...
  @Patch('brand-goals/:id')
  @UseGuards(CsrfProtectionGuard, MetaCompanyGoalManagementGuard)
  @ApiBody({ type: UpdateMetaCompanyGoalDto })
  @ApiOkResponse({ type: MetaCompanyBrandGoalResponseDto })
  public async updateBrandGoal(
    ...
    return mapBrandGoal(
      await this.metaCompanyService.updateBrandGoal(
        Number(id),
        stringValue(body.value),
        body.workingDays === undefined ? undefined : numberValue(body.workingDays),
        requireAuthenticatedUserId(request),
      ),
    );
  }

  @Patch('advisor-goals/:id')
  @UseGuards(CsrfProtectionGuard, MetaCompanyGoalManagementGuard)
  @ApiBody({ type: UpdateMetaCompanyGoalDto })
  @ApiOkResponse({ type: MetaCompanyAdvisorGoalResponseDto })
  public async updateAdvisorGoal(
    ...
    return mapAdvisorGoal(
      await this.metaCompanyService.updateAdvisorGoal(
        Number(id),
        stringValue(body.value),
        body.workingDays === undefined ? undefined : numberValue(body.workingDays),
        requireAuthenticatedUserId(request),
  ...
  @ApiBody({ type: CreateMetaCompanyEmpresaDto })
  @ApiCreatedResponse({ type: MetaCompanyEmpresaResponseDto })
  public async createEmpresa(
    @Req() request: AuthenticatedRequest,
    @Body() body: Record<string, unknown>,
  ) {
    return this.metaCompanyService.createEmpresa(
  ...
  @Patch('empresas/:id')
  @UseGuards(CsrfProtectionGuard, MetaCompanyCatalogManagementGuard)
  @ApiBody({ type: UpdateMetaCompanyEmpresaDto })
  @ApiOkResponse({ type: MetaCompanyEmpresaResponseDto })
  public async updateEmpresa(
    @Req() request: AuthenticatedRequest,
    @Param('id') id: string,
    @Body() body: Record<string, unknown>,
  ) {
    return this.metaCompanyService.updateEmpresa(
      Number(id),
      stringValue(body.code),
      stringValue(body.name),
      requireAuthenticatedUserId(request),
  ...
  @Patch('empresas/:id/active')
  @UseGuards(CsrfProtectionGuard, MetaCompanyCatalogManagementGuard)
  @ApiBody({ type: SetMetaCompanyCatalogItemActiveDto })
  @ApiOkResponse({ type: MetaCompanyEmpresaResponseDto })
  public async setEmpresaActive(
    @Req() request: AuthenticatedRequest,
    @Param('id') id: string,
    @Body() body: Record<string, unknown>,
  ) {
    return this.metaCompanyService.setEmpresaActive(
      Number(id),
      booleanValue(body.active),
      requireAuthenticatedUserId(request),
    );
  }
  ...
  @Patch('brands/:id')
  @UseGuards(CsrfProtectionGuard, MetaCompanyCatalogManagementGuard)
  @ApiBody({ type: UpdateMetaCompanyCatalogItemDto })
  @ApiOkResponse({ type: MetaCompanyCatalogItemResponseDto })
  public async updateBrand(
    @Req() request: AuthenticatedRequest,
    @Param('id') id: string,
    @Body() body: Record<string, unknown>,
  ) {
    return this.metaCompanyService.updateBrand(
      Number(id),
      numberValue(body.empresaId),
      stringValue(body.name),
      requireAuthenticatedUserId(request),
  ...
  public async setBrandActive(
    ...
    return this.metaCompanyService.setBrandActive(
      Number(id),
      booleanValue(body.active),
      requireAuthenticatedUserId(request),
    );
  ...
  public async updateBusiness(
    ...
    return this.metaCompanyService.updateBusiness(
      Number(id),
      numberValue(body.empresaId),
      stringValue(body.name),
      requireAuthenticatedUserId(request),
  ...
  public async setBusinessActive(
    ...
    return this.metaCompanyService.setBusinessActive(
      Number(id),
      booleanValue(body.active),
      requireAuthenticatedUserId(request),
    );
  ...
  @Post('advisors')
  @UseGuards(CsrfProtectionGuard, MetaCompanyCatalogManagementGuard)
  @ApiBody({ type: CreateMetaCompanyAdvisorDto })
  @ApiCreatedResponse({ type: MetaCompanyAdvisorResponseDto })
  public async createAdvisor(
    @Req() request: AuthenticatedRequest,
    @Body() body: Record<string, unknown>,
  ) {
    return this.metaCompanyService.createAdvisor(
      {
        empresaId: numberValue(body.empresaId),
        sourceSystem: stringValue(body.sourceSystem),
        externalCode: stringValue(body.externalCode),
  ...
  @Patch('advisors/:id')
  @UseGuards(CsrfProtectionGuard, MetaCompanyCatalogManagementGuard)
  @ApiBody({ type: UpdateMetaCompanyAdvisorDto })
  @ApiOkResponse({ type: MetaCompanyAdvisorResponseDto })
  public async updateAdvisor(
    @Req() request: AuthenticatedRequest,
    @Param('id') id: string,
    @Body() body: Record<string, unknown>,
  ) {
    return this.metaCompanyService.updateAdvisor(
      Number(id),
      {
        empresaId: numberValue(body.empresaId),
        sourceSystem: stringValue(body.sourceSystem),
  ...
  @Patch('advisors/:id/active')
  @UseGuards(CsrfProtectionGuard, MetaCompanyCatalogManagementGuard)
  @ApiBody({ type: SetMetaCompanyCatalogItemActiveDto })
  @ApiOkResponse({ type: MetaCompanyAdvisorResponseDto })
  public async setAdvisorActive(
    @Req() request: AuthenticatedRequest,
    @Param('id') id: string,
    @Body() body: Record<string, unknown>,
  ) {
    return this.metaCompanyService.setAdvisorActive(
      Number(id),
      booleanValue(body.active),
      requireAuthenticatedUserId(request),
    );
...
function mapBrandGoal(goal: BrandGoalWithRelations): MetaCompanyBrandGoalResponseDto {
  return {
    id: goal.id,
    period: goal.period.toISOString().slice(0, 10),
    businessId: goal.businessId,
...
function mapAdvisorGoal(goal: AdvisorGoalWithRelations): MetaCompanyAdvisorGoalResponseDto {
  return {
    ...
    businessName: goal.business.name,
    brandId: goal.brandId,
    brandName: goal.brand?.name ?? null,
    advisorId: goal.advisorId,
    advisorCode: goal.advisor.externalCode,
    advisorName: goal.advisor.displayName,
    value: goal.value.toFixed(2),
    workingDays: goal.workingDays,
    updatedAt: goal.updatedAt?.toISOString() ?? null,
  };
...
function stringValue(value: unknown): string {
  if (typeof value !== 'string') throw new BadRequestException('La solicitud es invalida.');
  return value;
}
function numberValue(value: unknown): number {
  if (typeof value !== 'number') throw new BadRequestException('La solicitud es invalida.');
  return value;
}
function booleanValue(value: unknown): boolean {
  if (typeof value !== 'boolean') throw new BadRequestException('La solicitud es invalida.');
  return value;
}
function requireAuthenticatedUserId(request: AuthenticatedRequest): string {
  if (request.authenticatedUser === undefined)
    throw new Error('El guard de sesion no adjunto un usuario autenticado.');
