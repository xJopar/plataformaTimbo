...
- El cuotero incorpora su identificador alfanumérico de ocho caracteres en un pie azul fino,
  alineado al extremo inferior derecho; es una referencia operativa para buscar la exportación,
  no un nuevo dato de cálculo.
